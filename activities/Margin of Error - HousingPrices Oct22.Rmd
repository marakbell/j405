...
10%, High = 57.2, Low = 46.8
3.5%, High = 54.9, Low = 51.1
5%, High = 57.8, Low = 52.3
...
Yes, the headline is statistically justified because with the largest sample size of 800, the margin of error stays above 50%, meaning that majority does support new city policy. 

Alternative headline: New City Policy relatively split among constituents. 
...
Recent data shows a community's new light rail line has increase  home values in Maryland's local neighborhood, according to local officials.

Before the transit line opened, homes in the neighborhood sold for an average of $285,000, compared to the current average of $304,500, roughly a 6.8% increase in prices. Local transit authorities say that the increase in prices could be owed to the rapid growth in businesses nearby the transportation hub. Authorities also said that with increased accessibility to the greater Washington Metropolitan area with the new transit line, demand for homes has increased, attracting new home buyers outside of the county. 
