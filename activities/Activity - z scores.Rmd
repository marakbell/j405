...
**
- I see that there are some outliers in the data, but daily overdose calls usually fell between 5 and 17 calls.
- There's a lot of density specifically 10-15 calls, but the density dipped between Oct. 2022 and January 2023 thereafter.
- The mean and median being closer together indicate that the data is relatively spread out symmetrically and that there are no significant outliers pulling the mean away from the median. You can see this visualized in the data below.
**
...
**
- This visualization made it much clearer to see which days had "unusual" amounts of calls by using z-scores to standardize what days are considered unusally high or low.
- You can see that unusually high call days are sprinkled throughout the time range with the highest spike occuring near October 2022. Unusually low call days also appear throughout the time range with the lowest two spikes occurring near June 2022 and and February 2023.
**
...
**On Oct. 4, 2022, there was an unusually high number of 911 overdose calls in Baltimore County for an average Tuesday, at 23 calls.**
...
**
- Based on our z-score analysis, some potential angles for reporting could focus on trends we might see for unusually high call volumes for overdoses.
- A high z-score would indicate here that the call count is unusually high while a low z-score would indicate that the call count is unusually low.
- It looks like Oct 4, 2022 had a very unusual number of calls, based on the z-score. I would be inclined as a reporter to look into the day, see if anything substantial happened, then would pitch to my editor a story that focuses on this angle. 
- For example I might say that the high cluster of overdoses might have to do with a bad batch of drugs produced that given month.
- From there, I file public information requests to see if there's any hard data that might show contaminants in drug suppliers and contact harm reduction specialists.
- I might also take a look at the low outliers, like on a Saturday in June, and see if there were any significant events taking place that day.
- I would review my calculations with other data reporters to make sure that my work isn't missing any additional calculations that would help inform my data.
- For the plot calls by month, it looks like March, April, and May had high average overdose calls. I would look into this and speak to experts to look for potential explanations for these high volumes. I would also look into this.
**
