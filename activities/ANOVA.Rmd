...
**
- Community college has the lowest average SAT score at 1068, compared to private (1435) and public college (1361).
- Community college has the largest standard deviation at 142.48184, meaning that data is less clustered around the mean and have a more spread out set of data than private and public college. 
- Public college has a standard deviation in between community college and private college at 109.02259, meaning that data is spread out, but not as much as community college. Private college has data that is more clustered around the mean, according to the standard deviation of 86.75233, than the other two types of colleges.
- For private and public schools, the max score is the same at 1600.000, while community college has a max score of 1393.962.
**
...
- There is a significant difference in SAT scores across college types. We can tell because  the ANOVA test shows three asterisks, indicating that the P-value is highly statistically significant and very small, less than the test statistic. It's further proven when we see that the F-value is  very high in comparison to the test statistics. This means that there is large variation between the groups (different types of Colleges). Furthermore, we can see that after performing the Tukey test, the comparison between each group has a very low P-value, meaning very high statistical significance.
- Private and community colleges have the largest difference between eachother, with a difference of 366.95577. Private colleges have SAT scores that are 366.96 points higher than community colleges on average. Public and community college has the second largest difference between eachother at 292.55140. Public colleges have SAT scores that are 292.55 points higher than community colleges on average. Public and private college doesn't have a great difference at a 74.40438 point difference. Public colleges have SAT scores that are 74.40 points lower than private colleges on average.
- Headline: Study shows SAT scores vary greatly between private and community schools.
- Lede: A new study released by Wells Research Fund shows that there are significant differences across college types (private, public, and community schools) and their average SAT scores, with community colleges nearly 367 points less than the average SAT score for private schools.
