...
**
- There's a very weak positive correlation between the FARMS percentage and math test scores.
- You can see this because the data points and very spread out rather than being clustered around the linear regression line. 
**
...
**
- Based on what I've learned so far, this model isn't worth using.
- This is because the p-value is very high at 0.123, rather than being anywhere near or closer to 0.05.
- This tells us that the nature of the relationship between FARMS percentage and math scores is not statistically significant.
**
...
**
- The largest differences between the predicted results and the actual math scores were 45.8, 38.9, and 30.9.
- These large residuals indicate that the model doesn't fit these data points well. A lot of the data points have very large residuals, so this could be suggested for the entire data set that the model isn't reliable.
**
...
**
- Based on this model's results, I would suggest that the school board member is incorrect. 
- The linear regression model shows no statistically significant relationship as indicated by the high p-value.
- Looking at the scatter plot, the correlation is also very weakly positive, suggesting that there is not a strong correlation.
- The adjusted R-squared also only shows that 2.5% of FARMS percentage explains why math scores differ across schools.
- This would influence a story pitch about the school board member and math scores by influencing me to look more into the school board member's intentions and see if there is any correlation with what they are arguing and their political motives.
**
