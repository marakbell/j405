...
**Some of the most important concerns with the methodology may include 1) the fact that the data is skewed to women because 55% of women were women and 38% were men, meaning that it doesn't fully represent the actual population as it is actually around 49% for women and 51% for men. 2) Racial and ethnic identities had to be collapsed "for analytical purposes", meaning that some specific ethnic groups wouldn't be considered. 3) Respondents with more than one racial identity are all grouped into the same identity, "multiracial," regardless of their own racial identities. That can be problematic because different mixed identities may experience different things. For example, even though I am Black and Asian, I identify more with my Black identity than even multiracial.**
...
1. What is the range of weights in this dataset? **2.8088**

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **A weight of 0.23 is very low, meaning that the respondent is overrepresented and counts as 0.23 of a person to compensate for that. On the other hand, a weight of 3.04 is very high because the respondent is underrepresented.**

3. Why might some respondents be weighted more heavily than others? **Some respondents may be weighted more heavily than others to compensate for the lack of representation in the dataset. For example, in the previous example where a respondent may be weighted 3.04, they may be weighted higher because they lack representation because they are a male, given that women were more likely to respond to the survey than men.**
...
1. Which voter category shows the biggest difference between weighted and unweighted results? **The "rarely/never" voter category showed the biggest difference between weighted and unweighted results, at -3.56, 1.99 and 1.56 compared to the "always" and "sporadic" categories, where the changes  are all less than 1.**

2. How might these differences affect reporting on likely voter turnout? **Reporting on the likely voter turnout will be more accurate because voters who rarely or never vote would be weighted less so that they are less represented in the final data. This is because these voters are likely to not vote in the actual election. This can be meaningful for reporting because it makes data more likely to be accurate to the final voter turnout.**

3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? **These differences exist because voters who have a history of not voting would be overrepresented in the sample if they say they will vote (given their history). If a lot of voters who say they'll vote but don't actually vote participate in the survey, the data will be skewed and less accurate to how the election would actually turn out. This is why weighting is crucial in polling a sample to try to be as representative as possible to the actual population.**
