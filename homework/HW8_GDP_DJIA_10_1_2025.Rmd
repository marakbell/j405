...
gdp_djia |> 
  ...
  labs(title = "Comparing Economic Indicators: DJIA v. GDP", x = "DJIA", y = "GDP")
```
...
# Answer: After creating a scatterplot looking at the correlation between DJIA and GDP, I found that there is a strong correlation between the variables. The scatterplot shows a strong positive correlation between the two variables, meaning that as DJIA increases, GDP also tends to increase. You can see this as the values cluster around the line of best fit. The correlation was also confirmed after calculating the correlation coefficient. Because r was greater than zero (0.9531058), that meant that there was a positive correlation. r was also very close to 1, meaning that the correlation was a near perfect, strong positive correlation.
