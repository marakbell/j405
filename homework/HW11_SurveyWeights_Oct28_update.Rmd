...
**Education levels in survey samples might differ from the general population because it is possible that those with higher education levels are more likely to respond to surveys than those with lower levels. Some factors might include their literacy levels and accessibility to surveys (through reading) along with understanding concepts about what the survey is about. If someone of lower levels of education doesn't understand what the survey is on, they may shy away from participating.**
...
**Based on the unweighted analysis, the headline may be: "New study shows that those with lower education levels are less likely to vote in the upcoming elections.**
...
**The percentages for the education groups College and Some college didn't change much. However, the high school or less showed the largest differences between weighted and unweighted results. For each voting intention, there was a >=1 point change. For example, Yes at 73.51291 became 70.77471 and No went from 14.590348	to 16.074799.**

2. Why might the weighted results be considered more accurate than the unweighted results?

**The weighted results might be considered more accurate than the unweighted results because it accounts for the varied levels of importance in each data point given. In this situation, there were more changes in High school or less than others because it likely was initially underrepresented and weighting changed the data to have this education group better represent the population.**
...
**The High school or less was the education group that shows the largest differences between weighted and unweighted results.**
...
**It's important for journalists to understand survey weighting when reporting on polls because the changes in the data between unweighted and weighted data can affect the results that the journalist is interpreting. We must understand that weighted data for surveys are more likely to be accurate because it better reflects the population by taking into account the over and underrepresented groups.**

2. How might the differences between weighted and unweighted results affect how you would report on this data?

**When looking at unweighted results, there are less steps in place to account for the varied representation of different groups. Using weighted results are more accurate because it can either give more weight to underrepresented groups or less weight to overrepresented groups. If I had the option to choose between weighted and unweighted results, I would choose weighted and include a disclaimer to show that the results were weighted to better represent the population I'm reporting on.**
...
**I'd want to know the reasons for why each groups were weighted the way they were, including comparisons between the population's demographics compared to the sample's and if the underrepresentation/overrepresentation is owed to specific social factors.**
