...
The results suggest that there may have been an increase or possibly a sustained heightened amount of car thefts since the spike year. However, this may not be reliable given that the sample sizes have changed a lot since the pre-spike year, with a sample size of 71, the spike year of a low 12, and the post-spike year of 14. The median rate roughly doubled from the pre-spike year at 22.2 to the post spike year at 46.1.
...
**WRITE YOUR ANSWER HERE**: The chart shows that the spike year occurred in 2023 at around 60 car thefts per 100,000 people then lowered at a relatively still high rate at around 43 car thefts per 100,000 people. TITLE: Car thefts in Prince George's County had a stunning spike in 2023, new study reports.
...
- **Null Hypothesis (H0)**:   Mean theft rates in Prince George's County did not differ significantly between the time periods.

- **Alternative Hypothesis (H1)**: Mean theft rates in Prince George's County differed significantly between the time periods.
...
**WRITE YOUR ANSWER HERE**: Yes, there are real differences in the average rates between the time periods. This result is significant because the three asteriks dictate that the p-value is highly statistically significant and very small, less than the test statistic. You can see this indicated also with the F-value which is very high at 218, much higher than the test statistics, meaning that the result is highly significant. 
...
**WRITE YOUR ANSWER HERE**: Pre-spike years car thefts rate per 100,000 people is 20.13231 thefts less than post-spike years rate. Spike years car thefts rate per 100,000 people is 16.62305 thefts higher than post-spike years rate. Spike years car thefts rate per 100,000 people is 36.75536 thefts higher than pre-spikes years rate. HEADLINE: New study shows significant difference between Prince George's County's spike year in car thefts and years before and after. LEDE: According to a Wells Research Study, Prince George's County car thefts rates signficantly spiked in 2023 and differences before and after those years are shown to be signficant.