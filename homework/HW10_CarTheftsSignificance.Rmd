...
**It looks like during summer months, there are spikes in car thefts, but overall thefts have been decreasing from 2023 to 2025. You can see the spikes at July 2023, where car thefts are a little above 650 thefts, then dip to nearly 450 thefts in January 2024, and even lower at roughly 325 thefts in the Spring of 2024. The number shoots back up (but not as high as much earlier before) in the Summer of 2024, hovering around 500 thefts.**
...
- What does the 95% confidence interval show here? **The 95% confidence interval, shown in the ribbon, shows that if you were to repeatedly conduct the study the same way, the true mean would fall within the ribbon 95 out of 100 times. The ribbon is relatively narrow, meaning that there is greater certainty around the mean compared to a wider ribbon.**

- What figure(s) accurately reflects the number of car thefts in a typical month? **The mean(total) accurately reflects the number of car thefts in a typical month. This is shown on the graph with the dashed line presenting the mean as 460.4 car thefts.**

- Propose a headline about the trend in car thefts that is focused on the present and future, but informed by the data you see above. **Study finds drop in Prince George's County car thefts in 2025 despite summer spikes.**
...
Given the above chart, is the difference between the two periods statistically significant? Can we reject the null hypothesis? **Given the above chart, we cannot reject the null hypothesis. This is because the p-value is 0.179 which is greater than our significance level at 0.05. This means that the difference between the first and second half is not statistically significant.**

How would you revise your headline from Task 6, if at all? What would you tell your editor, and what would you expect her to ask you? **I would revise my headline to: "Study finds summer spikes in car thefts remain in Prince George's County." I'd tell my editor that we'd need to find another angle because the data isn't statistically significant, which gives us no basis to claim that there was really a drop. She'd ask me to find another angle with the data and ask if I think the story is still worth doing.**
